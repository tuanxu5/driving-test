...
const licenseOptions = [
  { value: 'A1', label: 'Đề thi hạng A1', icon: Bike, group: 'Xe mô tô' },
  { value: 'A', label: 'Đề thi hạng A', icon: Bike, group: 'Xe mô tô' },
  { value: 'B1', label: 'Đề thi hạng B1', icon: Car, group: 'Xe ô tô' },
  { value: 'B', label: 'Đề thi hạng B', icon: Car, group: 'Xe ô tô' },
  { value: 'C', label: 'Đề thi hạng C', icon: Truck, group: 'Xe tải' },
  { value: 'C1', label: 'Đề thi hạng C1', icon: Truck, group: 'Xe tải' },
  { value: 'D', label: 'Đề thi hạng D', icon: Bus, group: 'Xe khách' },
  { value: 'D1', label: 'Đề thi hạng D1', icon: Bus, group: 'Xe khách' },
  { value: 'D2', label: 'Đề thi hạng D2', icon: Bus, group: 'Xe khách' },
  { value: 'BE', label: 'Đề thi hạng BE', icon: Truck, group: 'Xe kéo rơ moóc' },
  { value: 'C1E', label: 'Đề thi hạng C1E', icon: Truck, group: 'Xe kéo rơ moóc' },
  { value: 'CE', label: 'Đề thi hạng CE', icon: Truck, group: 'Xe kéo rơ moóc' },
  { value: 'D1E', label: 'Đề thi hạng D1E', icon: Bus, group: 'Xe kéo rơ moóc' },
  { value: 'D2E', label: 'Đề thi hạng D2E', icon: Bus, group: 'Xe kéo rơ moóc' },
  { value: 'DE', label: 'Đề thi hạng DE', icon: Bus, group: 'Xe kéo rơ moóc' },
];

const descriptions: Record<string, string> = {
  A1: 'Xe mô tô hai bánh có dung tích xi-lanh từ 50 cm³ đến dưới 175 cm³',
  A: 'Xe mô tô hai bánh có dung tích xi-lanh từ 175 cm³ trở lên',
  B1: 'Xe mô tô hai bánh, xe mô tô ba bánh và các loại xe ô tô chở người đến 9 chỗ ngồi',
  B: 'Xe ô tô chở người đến 9 chỗ ngồi, xe ô tô tải có trọng tải dưới 3.500kg',
  C: 'Xe ô tô tải có trọng tải từ 3.500 kg trở lên',
  C1: 'Xe ô tô tải có trọng tải từ 3.500 kg đến 7.500 kg',
  D: 'Xe ô tô chở người từ 10 đến 30 chỗ ngồi',
  D1: 'Xe ô tô chở người từ 10 đến 16 chỗ ngồi',
  D2: 'Xe ô tô chở người từ 17 đến 30 chỗ ngồi',
  BE: 'Xe ô tô hạng B kéo theo rơ moóc',
  C1E: 'Xe ô tô hạng C1 kéo theo rơ moóc',
  CE: 'Xe ô tô hạng C kéo theo rơ moóc',
  D1E: 'Xe ô tô hạng D1 kéo theo rơ moóc',
  D2E: 'Xe ô tô hạng D2 kéo theo rơ moóc',
  DE: 'Xe ô tô hạng D kéo theo rơ moóc',
};
